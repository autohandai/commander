...
export const BUILTIN_AGENT_PROFILES: BuiltInAgentProfile[] = [
  ...
  },
  {
    ...
    label: 'Cursor',
    shortLabel: 'Cursor',
    description: 'AI-powered code editor agent communicating via ACP protocol.',
    command: 'cursor',
    transport: 'acp',
    promptMode: 'protocol',
    protocol: 'acp',
  ...
  },
  {
    ...
    label: 'Pi',
    shortLabel: 'Pi',
    description: 'Minimal terminal coding agent with JSON-RPC protocol support.',
    command: 'pi',
    transport: 'json-rpc',
    promptMode: 'protocol',
    protocol: 'rpc',
